...
<body>
    ...
    <div class="" style='background:lightgray;'>
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <img src="./images/bodyBannerImage.png" class='w-100' alt="" />
                </div>
                        ...
                        <div class="row justify-content-around">
                            <div class="col-md-10">
                                <ul class='list-unstyled text-start BannerList'>
                                    <li><img src='./images/Check.png' style="width: 30px;" alt="checkedIcon" /> <b>Easy
                                            online booking</b></li>
                                    <li> <img src='./images/Check.png' style="width: 30px;" alt="checkedIcon" />
                                ...
                                <ul class='list-unstyled'>
                                    <li class='d-flex justify-content-around'>
                                        <img src="./images/appstore.jpg" class="rounded"
                                            style='width:100px; height:auto;' alt="" />
                                        <img src="./images/playStore.jpeg" class="rounded"
                                            style='width:100px; height:auto;' alt="" />
                                    </li>
                                    <!-- <li class='d-flex justify-content-around'>
                                        <img src="./images/line.png" style='width:65px; height:auto;' alt=""/>
                                        <img src="./images/line.png" style='width:120px; height:auto;' alt=""/>
                                        <img src="./images/line.png" style='width:120px; height:auto;' alt=""/>
                                    </li> -->
                                </ul>
                            </div>
    ...
    <div class="row mx-0 mt-4">
            ...
            <div class='boxShadow card' style="background-color: #f1f5f5;">
                ...
                <div class="card-body pb-0">
                    <div class="blockquote mb-0 text-center">
                        <img src="./images/step1.png" class='w-75' alt="" />
        ...
        <div class="col-12 col-md-4 px-4 simplestepcardArrage  ">
            <div class='boxShadow card' style="background-color: #f1f5f5;">
                ...
                <div class="card-body pb-0">
                    <div class="blockquote mb-0 text-center">
                        <img src="./images/step2.png" class='w-75' alt="" />
        ...
        <div class="col-12 col-md-4 px-4 simplestepcardArrage ">
            <div class='boxShadow card' style="background-color: #f1f5f5;">
                ...
                <div class="card-body pb-0">
                    <div class="blockquote mb-0 text-center">
                        <img src="./images/step3.png" class='w-75' alt="" />
    ...
    <div class="row mx-0 whyUsBg align-items-center pt-5 latoFont">
        ...
        <div class="col-12 col-md-6 ">
            <img src="./images/whyus.png" class='w-100' alt="" />
        </div>
