    ...
    <div class="row mx-0 latoFont">
        ...
        <div class="col-12 col-md-8">
            <div class="d-none d-md-block">
                <div class="row mx-0 border align-items-center " style='background:#C0ECED;'>
                    <div class="col-3 text-center">
                        <img src="./images/LEN-LEN-TEST-white.png" class='w-75 ' alt="" />

                    </div>
                    <div class="col-6">
                        <h4 style="font-weight:500" class="rubicFont nameHeading">LEN LEN TEST </h4>
                    </div>
                    <div class="col-3 d-flex flex-column justify-content-end">
                        <Button class='text-dark btn btn-block'><b class="priceCode">THB 6500</b></Button>
                        <a href="./BookingProcess.html" style=" text-decoration: none;">
            ...
            <div class="d-block d-md-none">
                <div class="row mx-0 border align-items-center " style='background:#C0ECED;'>
                    <div class="col-12">
                        <h4 style="font-weight:500" class="text-center h5 mt-3 rubicFont nameHeading">LEN LEN TEST </h4>
                    </div>
                    <div class="col-6">
                        <img src="./images/LEN-LEN-TEST-white.png" class='w-100' alt="" />
            ...
            <div class="row py-5 packDiscribe">
                <div class="col-12 col-md-7">
                    <p style=" line-height:31px">Sukaii Basic Health Check is a thorough health check via a blood sample
                        that covers all vital body functions and organs.
                        This test is recommended annually for all healthy adults and more regularly for those with
                ...
                <div class="col-12 w-100  ">
                    <div class="d-flex align-items-center mt-3">
                        ...
                        <div class="details_btn">
                            <button type="button" id="lenlenHealthCheckupShow" class="btn detalsBtn text-white btn-sm" style="border-radius: 6px;">View Details <span class="ml-1"><i class="fa-solid fa-chevron-down"></i></span></button>
                            <button type="button" id="lenlenHealthCheckupHide" class="btn btn-secondary btn-sm" style="border-radius: 6px; display: none;">Close Details <span class="ml-1"><i class="fa-solid fa-xmark"></i></span></button>
                        </div>
                    </div>
                    <div class="mt-4 show_services" id="lenlenHealthCheckup" style="display: none;">
                        <h6><small class="font-weight-bold sukaii_pink_color mb-2">Sukaii Len Len Test Package Includes
                                :</small></h6>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-4 border border-dark text-center py-1"><i class="fa-solid fa-xmark"></i>
                            </div>
                        </div>
                        <div class="row ">
