        ...
        <div class="col-12 col-md-8">
            <div class="d-none d-md-block">
                <div class="row mx-0 border align-items-center" style='background:#C0ECED;'>
                    <div class="col-3">
                        <img src="<?php echo base_url(); ?>assets/images/COMPLETE-HEALTH-CHECK-UP-white.png" class='w-100' alt="" />

                    </div>
                    <div class="col-6">
                        <h4 style="font-weight:500" class="rubicFont nameHeading">COMPLETE HEALTH CHECK UP1</h4>
                    </div>

                    <div class="col-3 d-flex flex-column justify-content-end">
                        <Button class='btn btn-block '><b class="priceCode"> THB 6500 </b></Button>
                        <a href="<?php echo base_url('serviceOrder/1483'); ?>" style=" text-decoration: none;">
            ...
            <div class="d-block d-md-none">
                <div class="row mx-0 border align-items-center" style='background:#C0ECED;'>
                    <div class="col-12">
                        <h4 style="font-weight:500" class="h5 mt-3 rubicFont nameHeading">COMPLETE HEALTH CHECK UP</h4>
                    </div>
                    <div class="col-6">
                        <img src="<?php echo base_url(); ?>assets/images/COMPLETE-HEALTH-CHECK-UP-white.png" class='w-100' alt="" />
            ...
            <div class="row py-5 packDiscribe">
                <div class="col-12 col-md-7">
                    <p style=" line-height:31px">Sukaii Complete Health Check is a comprehensive health check that
                        covers all vital body organs and functions and also tests for important cancer markers and
                        diseases. This test is recommended annually for everyone over the age of 60 and those with
                ...
                <div class="col-12 w-100 ">
                    <div class="d-flex align-items-center mt-3">
                        ...
                        <div class="details_btn">
                            <button type="button" id="completeHealthCheckupShow" class="btn detalsBtn text-white btn-sm" style="border-radius: 6px;">View Details <span class="ml-1"><i class="fa-solid fa-chevron-down"></i></span></button>
                            <button type="button" id="completeHealthCheckupHide" class="btn btn-secondary btn-sm" style="border-radius: 6px; display: none;">Close Details <span class="ml-1"><i class="fa-solid fa-xmark"></i></span></button>
                        </div>
                    </div>
