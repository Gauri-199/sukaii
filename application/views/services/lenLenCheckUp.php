        ...
        <div class="col-12 col-md-8">
            <div class="d-none d-md-block">
                <div class="row mx-0 border align-items-center " style='background:#C0ECED;'>
                    <div class="col-3 text-center">
                        <img src="<?php echo base_url(); ?>assets/images/LEN-LEN-TEST-white.png" class='w-75 ' alt="" />
            ...
            <div class="d-block d-md-none">
                <div class="row mx-0 border align-items-center " style='background:#C0ECED;'>
                    ...
                    <div class="col-6">
                        <img src="<?php echo base_url(); ?>assets/images/LEN-LEN-TEST-white.png" class='w-100' alt="" />
