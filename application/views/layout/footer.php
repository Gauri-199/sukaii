		...
		<div class="col-12 col-md-4 ">
			<ul class='list-unstyled'>
				<li class='d-flex justify-content-around'>
					<img src="<?=base_url()?>assets/images/appstore.jpg" style='width:120px; height:auto;' alt=""/>
					<img src="<?=base_url()?>assets/images/playStore.jpeg" style='width:120px; height:auto;' alt=""/>
				</li>
