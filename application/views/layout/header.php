	...
	<header id="" class='bg-white'>
		<div class="align-items-center border-bottom row">
			<div class="align-items-center col col-md-3 col-sm-6 d-flex">
				...
				<a href="<?= base_url('#AllServicePackages') ?>"><button type="button" id="BookingBtn" class="badge-pill border-white btn btn-sm font-weight-bold mt-4 px-3 text-white d-none d-md-block themeBlueBg latoFont" style="font-size: 13px;">Book Now</button></a>
			...
			<div class="tab_mobile_nav d-md-none  w-50" id="MobileMenuSection" style="display: none;">
				<ul class="list-unstyled border-0 pb-3 px-0 form-control">
					...
					<div class="border-bottom border-dark dropdown dropright pl-1 show">
						<a class="align-items-center d-flex dropdown-toggle px-2 py-2" style="font-weight: 600;" href="#" role="button" id="desktopServicemenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							Services
						</a>
						<div class="dropdown-menu" id="mobileServices" style="left: 65% !important;" aria-labelledby="desktopServicemenu">
							<a class="dropdown-item" href="<?php echo base_url(); ?>covidRTPCRcheckup">Covid RT-PCR Test</a>
							<a class="dropdown-item" href="<?php echo base_url(); ?>basicHeathjCheckup">Basic Health Check up</a>
							<a class="dropdown-item" href="<?php echo base_url(); ?>completeHealthCheckup">Complete Health Check up</a>
							<a class="dropdown-item" href="<?php echo base_url(); ?>lenLenCheckUp">Len- Len Test</a>
					...
					<!-- <div class="btn-group ">
						<button type="button" class="btn btn-secondary dropdown-toggle" id="mobilemenuService" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							Dropright
						</button>
					...
					<a href="<?= base_url('addCart') ?>" style="text-decoration: none;" class="text-dark">
						<li class="border-0 form-control mobile_menu_list rounded-0">Cart</li>
					</a>
					<a href="<?= base_url('#AllServicePackages') ?>" style="text-decoration: none;" class="text-dark">
					...
					<?php
						...
						?>
							<a href="<?= base_url('logout') ?>" style="text-decoration: none;" class=" text-dark">
								<li class="border-0 form-control mobile_menu_list rounded-0">Logout</li>
							</a>
						<?php
						} else { ?>
							<a href="<?= base_url('login') ?>" style="text-decoration: none;" class="text-dark">
								<li class="border-0 form-control mobile_menu_list rounded-0">Login</li>
							</a>
						<?php }
						?>
					<!-- <a href="#WeMadeItsImple" style="text-decoration: none;" class="text-dark">
